            ...
            <div className="cart_main_contner">
                        ...
                        <div className="product_description_cont">
                          <div className="descrp_remove_cont">
                            ...
                            <div className=" remove_container">
                              <button className="remove_button" onClick={(event)=>{removItemFn(index , event)}}>
              ...
              <div>
                <div className="total_price_container">
                  <div>
                    <div><span><p className="price_detail">Price Details</p></span></div>
                    <div>
                      <div className="total_prce">
                        <span ><p>Total Product Price</p></span>
                    ...
                    <div className="clicking_on"><span>clicking on 'Continue' will not deduct any money</span></div>
